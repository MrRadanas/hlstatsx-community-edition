...
function printMap($type = 'main')
{
    ...
    ?> 
		...
		<?php echo "preloadImages('".IMAGE_PATH."/mm_20_blue.png', ".(('main' == $type) ? "'".IMAGE_PATH."/mm_20_red.png', " : '')."'".IMAGE_PATH."/mm_20_shadow.png');"; ?>
...
<?php
    ...
    printMapCenter(('clan' == $type && '' != $clandata['mapregion']) ? $clandata['mapregion'] : $g_options['google_map_region']);
