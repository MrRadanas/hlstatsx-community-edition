...
$realkills     = (0 == $clandata['kills']) ? 1 : $clandata['kills'];
$realheadshots = (0 == $clandata['headshots']) ? 1 : $clandata['headshots'];
...
if (!empty($_GET['type']) && 'ajax' == $_GET['type']) {
...
<?php
	...
	var Tabs = new Tabs($('main_content'), $$('#main ul.subsection_tabs a'), {
		...
		'extra': {
            'clan': '<?php echo $clan; ?>',
            'members_page': '<?php echo $members_page; ?>'
        }
	});
	</script>
<?php
