...
class teamspeakDisplayClass
{
	...
	public function _setPlayerDisplayImage(&$playerInfo) {
	...
	public function _setPlayerDisplayName(&$playerInfo) {
	...
	public function _setChannelDisplayName(&$channelInfo) {
	...
	public function sortServerInfo(&$serverInfo) {
	...
	// be hard to read >:)
	public function displayTeamspeakEx($settings) {
