...
if (count($_POST) > 0) {
    ...
    if ($row = $db->fetch_array()) {
        ...
        if ([$game] = $db->fetch_row()) {
            $script_path = (isset($_SERVER['SSL']) || (isset($_SERVER['HTTPS']) && 'on' == $_SERVER['HTTPS'])) ? 'https://' : 'http://';
	...
	<td>
		...
		<table width="100%" border=0 cellspacing=1 cellpadding=4>
			<tr valign="bottom" class="head">
				...
				<td class='fSmall'><input type="text" name="server_address" maxlength="15" size="15" value="<?php echo $server_ip; ?>" /></td>
			</tr>
			<tr valign="bottom" class="head">
				<td class='fSmall'>Server Port</td>
				<td class='fSmall'><input type="text" name="server_port" maxlength="5" size="5" value="<?php echo $server_port; ?>" /></td>
			</tr>
			<tr valign="bottom" class="head">
				<td class='fSmall'>Server Name</td>
				<td class='fSmall'><input type="text" name="server_name" maxlength="255" size="35" value="<?php echo $server_name; ?>" /></td>
			</tr>
			<tr valign="bottom" class="head">
				<td class='fSmall'>Rcon Password</td>
				<td class='fSmall'><input type="text" name="server_rcon" maxlength="128" size="15" value="<?php echo $server_rcon; ?>" /></td>
			</tr>
			<tr valign="bottom" class="head">
				<td class='fSmall'>Public Address</td>
				<td class='fSmall'><input type="text" name="public_address" maxlength="128" size="15" value="<?php echo $server_public_address; ?>" /></td>
			</tr>
			<tr valign="bottom" class="head">
