...
if (1 == $g_options['show_weapon_target_flash']) {
...
if (0 != $db->num_rows($result)) {
	...
	<div class="subblock">
        ...
        $css_ct_weapons      = ['usp', 'tmp', 'm4a1',
                                        'aug', 'famas', 'sig550'];
        $css_ts_weapons = ['glock', 'elite', 'mac10',
                                        'ak47', 'sg552', 'galil',
                                        'g3sg1'];
        $css_random_weapons = ['knife', 'deagle', 'p228',
                                        'm3', 'xm1014', 'mp5navy',
                                        'p90', 'scout', 'awp',
                                        'm249', 'hegrenade', 'flashbang',
                                        'ump45', 'smokegrenade_projectile'];
        $dods_models         = ['allies', 'axis'];
        $dods_allies_weapons = ['thompson', 'colt', 'spring',
                                        'garand', 'riflegren_us', 'm1carbine',
                                        'bar', 'amerknife', '30cal',
                                        'bazooka', 'frag_us', 'riflegren_us',
                                        'smoke_us'];
        $dods_axis_weapons = ['spade', 'riflegren_ger', 'k98',
                                        'mp40', 'p38', 'frag_ger',
        ...
        $dinodday_allies_weapons = ['garand', 'greasegun', 'thompson', 'shotgun',
                                            'sten', 'carbine', 'bar', 'mosin', 'p38',
                                            'piat', 'nagant', 'flechette', 'pistol', 'trigger'];
        $dinodday_axis_weapons = ['mp40', 'k98', 'mp44', 'k98sniper', 'luger',
        ...
        while ($rowdata = $db->fetch_array()) {
            ...
            if ('css' == $realgame || 'cstrike' == $realgame) {
                if (in_array($rowdata['smweapon'], $css_random_weapons)) {
                    ...
                    $weapon_data[$rowdata['smweapon']]['model'] = $css_models[random_int(0, 2) + 3];
                } elseif (in_array($rowdata['smweapon'], $css_ts_weapons)) {
                    $weapon_data[$rowdata['smweapon']]['model'] = $css_models[random_int(0, 2)];
                }
            } elseif ('dods' == $realgame) {
