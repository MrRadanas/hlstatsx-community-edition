...
class Blocks
{
    ...
    public function setStartipnum(string $startipnum): Blocks
    {
    ...
    public function setEndipnum(string $endipnum): Blocks
    {
    ...
    public function setLocid(Location $location): Blocks
    {
        $this->locid = $location;
