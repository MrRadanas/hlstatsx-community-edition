 ...
 * HlstatsWeapons.
 *
 * @ORM\Table(name="hlstats_Weapons", uniqueConstraints={@ORM\UniqueConstraint(name="gamecode", columns={"game", "code"})}, indexes={@ORM\Index(name="code", columns={"code"}), @ORM\Index(name="modifier", columns={"modifier"})})
 *
