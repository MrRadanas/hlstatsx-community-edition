...
class EventsDisconnects
{
    ...
    public function setId(int $id): EventsDisconnects
    {
        $this->id = $id;
    ...
    public function setEventtime(\DateTime $eventtime): EventsDisconnects
    {
    ...
    public function setMap(string $map): EventsDisconnects
    {
        $this->map = $map;
